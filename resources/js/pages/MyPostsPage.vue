                ...
                <div class="card text-center">
                    <div class="card-header">
                        <ul class="nav nav-tabs card-header-tabs">
                            <li class="nav-item">
                                <router-link exact class="nav-link" :to="{ name: 'my-posts' }">All</router-link>
                            </li>
                            <li class="nav-item">
                                <router-link exact class="nav-link" :to="{ name: 'my-posts', query: { type: 'questions' } }">Questions</router-link>
                            </li>
                            <li class="nav-item">
                                <router-link exact class="nav-link" :to="{ name: 'my-posts', query: { type: 'answers' } }">Answers</router-link>
                            </li>
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-warning" v-else>
                            <p>You don't have any questions nor answers</p>
                            <p>
                                <router-link :to="{ name: 'questions.create' }">Ask a Question!</router-link>
                            </p>
                        </div>
                    </div>
                </div>
